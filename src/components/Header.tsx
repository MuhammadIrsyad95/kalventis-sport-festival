        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-60 flex">
          <div className="w-64 bg-white h-full flex flex-col shadow-xl animate-slideInLeft relative rounded-r-2xl">
            ...
            <nav className="flex-1 px-2 py-4 space-y-1">
              ...
              <a href="#matches-section" className="block px-4 py-3 text-gray-900 rounded hover:bg-indigo-50" onClick={() => setMobileMenuOpen(false)}>
                Pertandingan
              </a>
              <a href="#medals-section" className="block px-4 py-3 text-gray-900 rounded hover:bg-indigo-50" onClick={() => setMobileMenuOpen(false)}>
                Medali
              </a>
