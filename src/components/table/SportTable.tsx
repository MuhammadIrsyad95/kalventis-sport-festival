      ...
      <table className="min-w-full divide-y divide-gray-700">
        <thead className="bg-gray-700">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Media Link</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Aturan</th>
            <th className="px-4 py-3 text-right text-xs font-medium text-gray-300 uppercase tracking-wider">Aksi</th>
          </tr>
        </thead>
          ...
          {sports.length === 0 ? (
            ...
            sports.map((sport) => (
              <tr key={sport.id} className="hover:bg-gray-700">
                ...
                <td className="px-4 py-4 whitespace-nowrap text-white">{sport.name}</td>
                <td className="px-4 py-4 whitespace-nowrap text-white">{sport.kategori || '-'}</td>
                <td className="px-4 py-4 whitespace-nowrap text-white">
                  {sport.media_link ? (
                    <a href={sport.media_link} target="_blank" rel="noopener noreferrer" className="underline text-blue-400">
                      Lihat
                    </a>
                  ) : (
                    '-'
                ...
                <td className="px-4 py-4 whitespace-nowrap text-white">{sport.rules || '-'}</td>
